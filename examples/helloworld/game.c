...
static void game_read_line(game_puts_fn puts_fn, game_getc_fn getc_fn, char *buf, int size)
{
    int i = 0;
...
static void render_board(game_puts_fn puts_fn, int board[SUDOKU_SIZE][SUDOKU_SIZE])
{
    char line[48];
...
static void print_help(game_puts_fn puts_fn)
{
    puts_fn(
        "\r\nMini Sudoku 4x4\r\n"
